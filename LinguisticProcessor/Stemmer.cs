    ...
    public class Stemmer
    {
        ...
        private bool isShortSyllable(StringBuilder s, int offset)
        {
            if ((offset == 0) && (isVowel(s, 0)) && (!isVowel(s, 1)))
                return true;
            return ((offset > 0) && (offset < s.Length - 1)) 
                   && isVowel(s, offset) 
                   && !isVowel(s, offset + 1) 
                   && (s[offset + 1] != 'w' 
                       && s[offset + 1] != 'x' 
        ...
        private void step1a(StringBuilder sb)
        {
            ...
            if ((sb.Length >= 4) && sb.ToString(sb.Length - 4, 4) == "sses")
                sb.Replace("sses", "ss", sb.Length - 4, 4);
                     ...
                     (sb.ToString(sb.Length - 3, 3) == "ied" || sb.ToString(sb.Length - 3, 3) == "ies"))
            {
                if (sb.Length > 4)
                    ...
                    sb.Replace(sb.ToString(sb.Length - 3, 3), "ie", sb.Length - 3, 3);
                     ...
                     (sb.ToString(sb.Length - 2, 2) == "us" || sb.ToString(sb.Length - 2, 2) == "ss"))
                return;
            else if ((sb.Length > 0) && (sb.ToString(sb.Length - 1, 1) == "s"))
            {
